...
try {
    ...
    $getClientId = admFuncVariableIsValid($_GET, 'id', 'int');
    ...
    switch ($getMode) {
        ...
        case 'edit_saml':
            // create html page object
            $page = new SSOClientPresenter($getClientId);
        ...
        case 'save_saml':
            $menuModule = new SAMLService($gDb, $gCurrentUser);
            $menuModule->save($getClientId);
