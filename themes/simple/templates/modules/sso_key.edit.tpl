<form {foreach $attributes as $attribute}
    ...
    <div class="card admidio-field-group">
        <div class="card-header">{$l10n->get('SYS_SSO_CERTIFICATE_SETTINGS')} {include 'sys-template-parts/form.button.tpl' data=$elements['adm_button_certificate_dataedit']}</div>
        <div class="card-body">
    ...
    {include 'sys-template-parts/form.button.tpl' data=$elements['adm_button_certificate']}
    {include 'sys-template-parts/form.button.tpl' data=$elements['adm_button_regenerate']}
